    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] font-['Plus_Jakarta_Sans',sans-serif] overflow-x-hidden">
            ...
            <nav className="fixed top-4 left-4 right-4 z-50 bg-white/80 backdrop-blur-md border border-white/20 shadow-xl shadow-indigo-100 max-w-7xl mx-auto rounded-2xl transition-all duration-300">
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <a href="#testimonials" className="text-sm font-bold text-slate-500 hover:text-slate-900 transition-colors">Testimonials</a>
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden absolute top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl shadow-indigo-100 p-6 flex flex-col gap-4 animate-fade-in-down mx-0">
                        <a
                            href="#features"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-black text-slate-900">Alex R.</p>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-slate-200 rounded-full"></div>
                                <div>
                                    <p className="text-sm font-black text-slate-900">Sarah J.</p>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-slate-200 rounded-full"></div>
                                <div>
                                    <p className="text-sm font-black text-slate-900">Mike T.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    <div className="bg-white p-10 rounded-[40px] border border-slate-200 hover:border-indigo-100 transition-all">
                        ...
                        <ul className="space-y-4 mb-10">
                            ...
                            <li className="flex items-center gap-3 text-slate-600 font-bold"><span className="text-indigo-600">✓</span> 7-Day History</li>
                        </ul>
                        <button onClick={onLoginClick} className="w-full py-4 rounded-2xl font-bold bg-slate-100 text-slate-900 hover:bg-slate-200 transition-colors">Get Started</button>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-lg font-black text-slate-900">FocusBoard</span>
                        </div>
                        <p className="text-slate-500 text-sm font-medium">Building the future of personal productivity.</p>
                    </div>

                    <div>
                        <h4 className="font-black text-slate-900 mb-4">Links</h4>
                    ...
                    <div>
                        <h4 className="font-black text-slate-900 mb-4">Newsletter</h4>
                        <div className="flex gap-2">
                            <input type="email" placeholder="Email" className="bg-white border-none rounded-xl px-4 py-2 text-sm font-bold text-slate-700 outline-none focus:ring-2 focus:ring-indigo-500 w-full" />
                            <button className="bg-slate-900 text-white px-4 py-2 rounded-xl font-bold text-sm hover:bg-slate-800">→</button>
                        </div>
                    </div>
                </div>
            </footer>
